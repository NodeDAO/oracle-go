...
// GetNftCountsOfOperator is a free data retrieval call binding the contract method 0xc36c5719.
//
// Solidity: function getNftCountsOfOperator(uint256 _operatorId) view returns(uint256)
func (_Vnft *VnftCaller) GetNftCountsOfOperator(opts *bind.CallOpts, _operatorId *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Vnft.contract.Call(opts, &out, "getNftCountsOfOperator", _operatorId)
...
//
// Solidity: function getNftCountsOfOperator(uint256 _operatorId) view returns(uint256)
func (_Vnft *VnftSession) GetNftCountsOfOperator(_operatorId *big.Int) (*big.Int, error) {
	return _Vnft.Contract.GetNftCountsOfOperator(&_Vnft.CallOpts, _operatorId)
}

// GetNftCountsOfOperator is a free data retrieval call binding the contract method 0xc36c5719.
//
// Solidity: function getNftCountsOfOperator(uint256 _operatorId) view returns(uint256)
func (_Vnft *VnftCallerSession) GetNftCountsOfOperator(_operatorId *big.Int) (*big.Int, error) {
	return _Vnft.Contract.GetNftCountsOfOperator(&_Vnft.CallOpts, _operatorId)
}
...
//
// Solidity: function getUserNftWithdrawalCredentialOfTokenId(uint256 tokenId) view returns(bytes)
func (_Vnft *VnftCaller) GetUserNftWithdrawalCredentialOfTokenId(opts *bind.CallOpts, tokenId *big.Int) ([]byte, error) {
	var out []interface{}
	err := _Vnft.contract.Call(opts, &out, "getUserNftWithdrawalCredentialOfTokenId", tokenId)
...
//
// Solidity: function getUserNftWithdrawalCredentialOfTokenId(uint256 tokenId) view returns(bytes)
func (_Vnft *VnftSession) GetUserNftWithdrawalCredentialOfTokenId(tokenId *big.Int) ([]byte, error) {
	return _Vnft.Contract.GetUserNftWithdrawalCredentialOfTokenId(&_Vnft.CallOpts, tokenId)
}

// GetUserNftWithdrawalCredentialOfTokenId is a free data retrieval call binding the contract method 0x25171570.
//
// Solidity: function getUserNftWithdrawalCredentialOfTokenId(uint256 tokenId) view returns(bytes)
func (_Vnft *VnftCallerSession) GetUserNftWithdrawalCredentialOfTokenId(tokenId *big.Int) ([]byte, error) {
	return _Vnft.Contract.GetUserNftWithdrawalCredentialOfTokenId(&_Vnft.CallOpts, tokenId)
}

// GetUsernftGasHeight is a free data retrieval call binding the contract method 0x1f5cdae6.
//
...
//
// Solidity: function setNftExitBlockNumbers(uint256[] tokenIds, uint256[] exitBlockNumbers) returns()
func (_Vnft *VnftTransactor) SetNftExitBlockNumbers(opts *bind.TransactOpts, tokenIds []*big.Int, exitBlockNumbers []*big.Int) (*types.Transaction, error) {
	return _Vnft.contract.Transact(opts, "setNftExitBlockNumbers", tokenIds, exitBlockNumbers)
}

// SetNftExitBlockNumbers is a paid mutator transaction binding the contract method 0x677f068a.
//
// Solidity: function setNftExitBlockNumbers(uint256[] tokenIds, uint256[] exitBlockNumbers) returns()
func (_Vnft *VnftSession) SetNftExitBlockNumbers(tokenIds []*big.Int, exitBlockNumbers []*big.Int) (*types.Transaction, error) {
	return _Vnft.Contract.SetNftExitBlockNumbers(&_Vnft.TransactOpts, tokenIds, exitBlockNumbers)
}

// SetNftExitBlockNumbers is a paid mutator transaction binding the contract method 0x677f068a.
//
// Solidity: function setNftExitBlockNumbers(uint256[] tokenIds, uint256[] exitBlockNumbers) returns()
func (_Vnft *VnftTransactorSession) SetNftExitBlockNumbers(tokenIds []*big.Int, exitBlockNumbers []*big.Int) (*types.Transaction, error) {
	return _Vnft.Contract.SetNftExitBlockNumbers(&_Vnft.TransactOpts, tokenIds, exitBlockNumbers)
}
