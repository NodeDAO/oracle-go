...
// ActiveNftsOfUser is a free data retrieval call binding the contract method 0x43f2101c.
//
// Solidity: function activeNftsOfUser() view returns(uint256[])
func (_Vnft *VnftCaller) ActiveNftsOfUser(opts *bind.CallOpts) ([]*big.Int, error) {
	var out []interface{}
	err := _Vnft.contract.Call(opts, &out, "activeNftsOfUser")
...
//
// Solidity: function activeNftsOfUser() view returns(uint256[])
func (_Vnft *VnftSession) ActiveNftsOfUser() ([]*big.Int, error) {
	return _Vnft.Contract.ActiveNftsOfUser(&_Vnft.CallOpts)
}

// ActiveNftsOfUser is a free data retrieval call binding the contract method 0x43f2101c.
//
// Solidity: function activeNftsOfUser() view returns(uint256[])
func (_Vnft *VnftCallerSession) ActiveNftsOfUser() ([]*big.Int, error) {
	return _Vnft.Contract.ActiveNftsOfUser(&_Vnft.CallOpts)
}

// ActiveValidatorOfUser is a free data retrieval call binding the contract method 0x08f24b1a.
//
// Solidity: function activeValidatorOfUser() view returns(bytes[])
func (_Vnft *VnftCaller) ActiveValidatorOfUser(opts *bind.CallOpts) ([][]byte, error) {
	var out []interface{}
	err := _Vnft.contract.Call(opts, &out, "activeValidatorOfUser")
...
//
// Solidity: function activeValidatorOfUser() view returns(bytes[])
func (_Vnft *VnftSession) ActiveValidatorOfUser() ([][]byte, error) {
	return _Vnft.Contract.ActiveValidatorOfUser(&_Vnft.CallOpts)
}

// ActiveValidatorOfUser is a free data retrieval call binding the contract method 0x08f24b1a.
//
// Solidity: function activeValidatorOfUser() view returns(bytes[])
func (_Vnft *VnftCallerSession) ActiveValidatorOfUser() ([][]byte, error) {
	return _Vnft.Contract.ActiveValidatorOfUser(&_Vnft.CallOpts)
}
...
// GetMultipleValidatorWithdrawalCredentials is a free data retrieval call binding the contract method 0x6e2e2c61.
//
// Solidity: function getMultipleValidatorWithdrawalCredentials(uint256 _operatorId, uint256 _number) view returns(bytes[])
func (_Vnft *VnftCaller) GetMultipleValidatorWithdrawalCredentials(opts *bind.CallOpts, _operatorId *big.Int, _number *big.Int) ([][]byte, error) {
	var out []interface{}
	err := _Vnft.contract.Call(opts, &out, "getMultipleValidatorWithdrawalCredentials", _operatorId, _number)
...
//
// Solidity: function getMultipleValidatorWithdrawalCredentials(uint256 _operatorId, uint256 _number) view returns(bytes[])
func (_Vnft *VnftSession) GetMultipleValidatorWithdrawalCredentials(_operatorId *big.Int, _number *big.Int) ([][]byte, error) {
	return _Vnft.Contract.GetMultipleValidatorWithdrawalCredentials(&_Vnft.CallOpts, _operatorId, _number)
}

// GetMultipleValidatorWithdrawalCredentials is a free data retrieval call binding the contract method 0x6e2e2c61.
//
// Solidity: function getMultipleValidatorWithdrawalCredentials(uint256 _operatorId, uint256 _number) view returns(bytes[])
func (_Vnft *VnftCallerSession) GetMultipleValidatorWithdrawalCredentials(_operatorId *big.Int, _number *big.Int) ([][]byte, error) {
	return _Vnft.Contract.GetMultipleValidatorWithdrawalCredentials(&_Vnft.CallOpts, _operatorId, _number)
}
...
// OperatorEmptyNftCounts is a free data retrieval call binding the contract method 0x67abe605.
//
// Solidity: function operatorEmptyNftCounts(uint256 ) view returns(uint256)
func (_Vnft *VnftCaller) OperatorEmptyNftCounts(opts *bind.CallOpts, arg0 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Vnft.contract.Call(opts, &out, "operatorEmptyNftCounts", arg0)
...
//
// Solidity: function operatorEmptyNftCounts(uint256 ) view returns(uint256)
func (_Vnft *VnftSession) OperatorEmptyNftCounts(arg0 *big.Int) (*big.Int, error) {
	return _Vnft.Contract.OperatorEmptyNftCounts(&_Vnft.CallOpts, arg0)
}

// OperatorEmptyNftCounts is a free data retrieval call binding the contract method 0x67abe605.
//
// Solidity: function operatorEmptyNftCounts(uint256 ) view returns(uint256)
func (_Vnft *VnftCallerSession) OperatorEmptyNftCounts(arg0 *big.Int) (*big.Int, error) {
	return _Vnft.Contract.OperatorEmptyNftCounts(&_Vnft.CallOpts, arg0)
}
